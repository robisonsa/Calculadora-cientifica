...
-- LIMIT 1 para evitar erro quando houver turmas duplicadas
UPDATE profiles
SET turma_id = (SELECT id FROM turmas WHERE nome = '9º Ano EF' AND escola = 'CEGLB' LIMIT 1)
WHERE ano_escolar = '9EF' AND role = 'estudante';

UPDATE profiles
SET turma_id = (SELECT id FROM turmas WHERE nome = '5º Ano EF' AND escola = 'CEGLB' LIMIT 1)
WHERE ano_escolar = '5EF' AND role = 'estudante';

UPDATE profiles
SET turma_id = (SELECT id FROM turmas WHERE nome = '2º Ano EF' AND escola = 'CEGLB' LIMIT 1)
